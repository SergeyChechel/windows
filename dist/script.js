...
var changeModalState = function changeModalState(state) {
  ...
  function bindActionToEvent(event, elem, prop) {
  ...
  bindActionToEvent('click', windowForm, 'form');
  bindActionToEvent('input', windowWidth, 'width');
  bindActionToEvent('input', windowHeight, 'height');
  bindActionToEvent('change', windowType, 'type');
  bindActionToEvent('change', windowProfile, 'profile');
};
...
/*!*********************************!*\
  !*** ./src/js/modules/forms.js ***!
  \*********************************/
/*! exports provided: addStatusMessage, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var forms = function forms(state) {
  ...
  var clearInputs = function clearInputs() {
    var selectOpts = document.querySelectorAll('#view_type option');
...
function addStatusMessage(elemOrSelector, status) {
  var el,
      mess,
      flag = false;
      ...
      el.addEventListener('click', function (e) {
        ...
        if (triggerSelector === '.popup_calc_button') {
          if (!validate(state, '.popup_calc')) {
            Object(_forms__WEBPACK_IMPORTED_MODULE_4__["addStatusMessage"])('.popup_calc_content', 'info');
            return;
          }
        ...
        if (triggerSelector === '.popup_calc_profile_button') {
          if (!validate(state, '.popup_calc_profile')) {
            Object(_forms__WEBPACK_IMPORTED_MODULE_4__["addStatusMessage"])('.popup_calc_profile_content', 'info');
            return;
          }
